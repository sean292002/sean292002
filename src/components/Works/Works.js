...
const Works = ({ project }) => {
  const { title, description, technologies, images, moreinfo } = project;
    ...
    <section id="blogs" className="container">
      <div className='container-works'>
        ...
        <div className='works-detail'>
          ...
          <br/>
          <p>{description}</p>
          {/* <a href={project.moreInfoUrl} target="_blank" rel="noopener noreferrer">View More</a>
           */}
          {moreinfo && moreinfo.length > 0 && moreinfo.map((link, linkIndex) => (
          <p key={linkIndex}>
