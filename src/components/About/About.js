      ...
      <div className="container-about">
        ...
        <div className="about-left">
          ...
          <div className="about-download">
            <Button className="resume-button" variant="contained" href={fileResume} target="_blank" rel="noopener noreferrer">
              Resume
            </Button>
            <Button className="resume-button" variant="contained" href={fileTranscript} target="_blank" rel="noopener noreferrer">
              Transcript
            </Button>
          </div>
        </div>
